            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form action="{{route('annonce.update', $annonce->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div >
                        ...
                        <x-jet-input id="title" value="{{ $annonce->title}}" class="block mt-1 w-full" type="text" name="title" required />
                    </div>

                    <div class="mt-4">
                        <x-jet-label for="content" value="{{ __('Description de l annonce') }}" />
                        <x-jet-input id="content" value="{{ $annonce->content}}" class="block mt-1 w-full" type="textarea" name="content" />
                    </div>
                    ...
                    <div class="mt-4">
                        ...
                        <x-jet-input id="prix" value="{{ $annonce->prix}}" class="block mt-1 w-full" type="number" name="prix"  />
                    </div>
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                        ...
                        <x-jet-input id="adresse" value="{{ $annonce->adresse}}" class="block mt-1 w-full" type="tel" name="adresse"/>
                    </div>
