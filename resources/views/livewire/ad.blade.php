<div>
    <div class="lg:w-4/5 mx-auto p-5 flex rounded-sm shadow border-gray-500 flex-wrap">
        ...
        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <button wire:click="addLike" class="rounded-full focus:outline-none hover:bg-blue-500 w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-gray-500 ml-4">
                <svg fill="{{ $annonce->isLiked() ? 'red':'' }}" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
